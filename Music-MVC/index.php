...
<body>
    <header class="header">
        <div class="container">
            ...
            <nav class="nav" id="nav">
                ...
                <a href="#" id="loginTrigger">Login</a> <a href="#contact">Contato</a>
            </nav>
    ...
    foreach ($files as $filePath) {
        ...
        $displayName = preg_replace('/\.mp3$/i', '', $fileName);
        $displayName = str_replace(['_', '-'], [' ', ' -'], $displayName);
        $displayName = trim($displayName);

        echo '<li class="playlist-item" data-src="' . htmlspecialchars($filePath) . '">';
